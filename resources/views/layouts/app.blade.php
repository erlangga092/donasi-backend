...
<body>
  <div x-data="{ sidebarOpen: false }" class="font-roboto flex h-screen bg-gray-200">
    <div :class="sidebarOpen ? 'block' : 'hidden'"
      class="fixed inset-0 z-20 bg-black opacity-50 transition-opacity lg:hidden" @click="sidebarOpen = false"></div>
    ...
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <div class="my-2 flex items-center justify-center">
        <div class="flex items-center py-1">
          ...
          {{-- <span class="mx-2 text-lg font-semibold text-white">Donasi</span> --}}
        </div>
      </div>

      <nav class="mt-5">
        <a class="{{ Request::is('admin/dashboard*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} mt-4 flex items-center py-2 px-6 hover:bg-opacity-25 hover:text-gray-100"
        ...
        <a class="{{ Request::is('admin/category*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} mt-4 flex items-center py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
        ...
        <a class="{{ Request::is('admin/campaign*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }} mt-4 flex items-center py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      ...
      <header class="flex items-center justify-between bg-white py-4 px-6">
        ...
        <div class="flex items-center">
          ...
          <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-show="dropdownOpen" class="fixed inset-0 z-10 h-full w-full" @click="dropdownOpen = false"></div>

            <div x-show="dropdownOpen"
              class="absolute right-0 z-10 mt-2 w-48 overflow-hidden rounded-md bg-white shadow-sm">

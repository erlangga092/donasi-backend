            ...
            <form action="{{ route('login') }}" class="mt-4" method="POST">
                ...
                <label class="block mt-3">
                    ...
                    <input type="password" name="password"
                        class="form-input mt-1 block w-full rounded-md focus:outline-none" placeholder="Password">
                    @error('password')
                        <div class="inline-flex max-w-sm w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-3">
                                <p class="text-gray-600 text-sm">
                ...
                <div class="flex justify-between items-center mt-4">
                    ...
                    <div>
                        <a href="/forgot-password" class="block text-sm fontme text-indigo-700 hover:underline">
                            Lupa Password?
                        </a>
                    </div>
                </div>

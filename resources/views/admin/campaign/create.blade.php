      ...
      <div class="rounded-md bg-white p-6 shadow-md">
        ...
        <form action="{{ route('admin.campaign.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mt-4 grid grid-cols-1 gap-6">
            ...
            <div class="">
              ...
              <input type="text" class="form-input mt-2 w-full rounded-md border bg-gray-200 p-3 focus:bg-white"
                name="title" placeholder="Judul Campaign" value="{{ old('title') }}">
              @error('title')
                <div class="mt-2 w-full overflow-hidden rounded-md bg-red-200 shadow-sm">
                  <div class="px-4 py-2">
                    <p class="text-sm text-gray-600">{{ $message }}</p>
            ...
            <div class="">
              ...
              <input type="number" class="form-input mt-2 w-full rounded-md border bg-gray-200 p-3 focus:bg-white"
                name="target_donation" placeholder="Target Donasi" value="{{ old('target_donation') }}">
            ...
            <div class="">
              ...
              <input type="date" class="form-input mt-2 w-full rounded-md border bg-gray-200 p-3 focus:bg-white"
                name="max_date" placeholder="Tanggal Berakhir" value="{{ old('max_date') }}">
              @error('max_date')
                <div class="mt-2 w-full overflow-hidden rounded-md bg-red-200 shadow-sm">
                  <div class="px-4 py-2">
                    <p class="text-sm text-gray-600">{{ $message }}</p>
          ...
          <div class="mt-6 flex justify-start">
            <button type="submit"
              class="rounded-md bg-gray-600 px-4 py-2 text-gray-200 hover:bg-gray-700 focus:bg-gray-700 focus:outline-none">SIMPAN</button>
          </div>
        </form>
      </div>
    </div>
